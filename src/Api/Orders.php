...
class Orders extends Client
{
     ...
     * @return mixed
     */
    public function getOrders($queryParams = [], $version = 'v0')
    {
        return $this->send("/orders/{$version}/orders", [
            'method' => 'GET',
            'query' => $queryParams,
        ]);
    }
     ...
     * @return mixed
     */
    public function getOrder($orderId, $version = 'v0')
    {
        return $this->send("/orders/{$version}/orders/{$orderId}", [
            'method' => 'GET',
        ]);
    }
     ...
     * @return mixed
     */
    public function getOrderBuyerInfo($orderId, $version = 'v0')
    {
        return $this->send("/orders/{$version}/orders/{$orderId}/buyerInfo", [
            'method' => 'GET',
        ]);
    }
     ...
     * @return mixed
     */
    public function getOrderAddress($orderId, $version = 'v0')
    {
        return $this->send("/orders/{$version}/orders/{$orderId}/address", [
            'method' => 'GET',
        ]);
    }
     ...
     * @return mixed
     */
    public function getOrderItems($orderId, $queryParams = [], $version = 'v0')
    {
        return $this->send("/orders/{$version}/orders/{$orderId}/orderItems", [
            'method' => 'GET',
            'query' => $queryParams,
        ]);
    }
     ...
     * @return mixed
     */
    public function getOrderItemsBuyerInfo($orderId, $queryParams = [], $version = 'v0')
    {
        return $this->send("/orders/{$version}/orders/{$orderId}/orderItems/buyerInfo", [
            'method' => 'GET',
            'query' => $queryParams,
        ]);
    }
     ...
     * @return mixed
     */
    public function updateShipmentStatus($orderId, $body = [], $version = 'v0')
    {
        return $this->send("/orders/{$version}/orders/{$orderId}/shipment", [
            'method' => 'POST',
            'json' => $body
        ]);
    }
