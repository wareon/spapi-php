...
class Reports extends Client
{
     ...
     * @return mixed
     */
    public function getReports($queryParams = [], $version = '2020-09-04')
    {
        return $this->send("/reports/{$version}/reports", [
            'method' => 'GET',
            'query' => $queryParams,
        ]);
    }
     ...
     * @return mixed
     */
    public function createReport($body = [], $version = '2020-09-04')
    {
        return $this->send("/reports/{$version}/reports", [
            'method' => 'POST',
            'json' => $body
     ...
     * @return mixed
     */
    public function cancelReport($reportId, $version = '2020-09-04')
    {
        return $this->send("/reports/{$version}/reports/{$reportId}", [
            'method' => 'DELETE',
        ]);
    }
     ...
     * @return mixed
     */
    public function getReport($reportId, $version = '2020-09-04')
    {
        return $this->send("/reports/{$version}/reports/{$reportId}", [
            'method' => 'GET',
        ]);
     ...
     * @return mixed
     */
    public function getReportSchedules($queryParams = [], $version = '2020-09-04')
    {
        return $this->send("/reports/{$version}/schedules", [
            'method' => 'GET',
            'query' => $queryParams,
        ]);
    }
     ...
     * @return mixed
     */
    public function createReportSchedule($body = [], $version = '2020-09-04')
    {
        return $this->send("/reports/{$version}/schedules", [
            'method' => 'POST',
            'json' => $body
     ...
     * @return mixed
     */
    public function cancelReportSchedule($reportScheduleId, $version = '2020-09-04')
    {
        return $this->send("/reports/{$version}/schedules/{$reportScheduleId}", [
            'method' => 'DELETE',
        ]);
    }
     ...
     * @return mixed
     */
    public function getReportSchedule($reportScheduleId, $version = '2020-09-04')
    {
        return $this->send("/reports/{$version}/schedules/{$reportScheduleId}", [
            'method' => 'GET',
        ]);
     ...
     * @return mixed
     */
    public function getReportDocument($reportDocumentId, $version = '2020-09-04')
    {
        return $this->send("/reports/{$version}/documents/{$reportDocumentId}", [
            'method' => 'GET',
        ]);
    }
}
